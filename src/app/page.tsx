...
export default function Home() {
  ...
  return (
    <main className="flex flex-col bg-[#100d0a] text-slate-200">
      <div className="">
        <Image className="opacity-5" src="/herobg.png" layout="fill" alt="" />
        <div className="absolute bottom-0 w-full">
          <GradientDiv />
        </div>
        <div className="z-50 w-full min-h-screen flex flex-col items-center py-5 justify-between">
          <Header />
          <div className="flex flex-col md:flex-row mt-10 md:mt-0 gap-[2rem] md:gap-[10rem] items-center">
...
const GradientDiv: React.FC = () => {
  return (
    <div className="h-[100px] w-full bg-gradient-to-t from-[#100d0a] via-transparent to-transparent" />
  );
};
